package com.backend.app.services.controller;


import com.backend.app.services.dtos.ServiceEntityDTO;
import com.backend.app.services.services.ServiceEntityService;
...
public class ServiceEntityController {
    ...
    public List<ServiceEntityDTO> getServicesByProviderId(@PathVariable Long providerId) {
        return serviceEntityService.getServicesByProviderId(providerId);
    }
